...
const InquiryTableCard = ({ inquiry, i }) => {
  ...
  return (
    <TableRow>
      ...
      <TableCell className="text-center py-2 px-4 border-b">
      ...
      <TableCell
        className="text-center text-xs xl:text-base py-2 px-2 border-b bg-blue-500 text-white font-bold cursor-pointer hover:bg-blue-600 duration-200 rounded"
